...
The trait-SNP association test is carried out by \code{gee.lgst.imputed} function where the 
...
\end{Arguments}
\begin{Details}\relax
Similar to the details for \code{gee.lgst.batch} but here the SNP data contains imputed genotypes (allele dosages) 
